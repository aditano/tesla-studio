...
export const SHOTS: Record<FeatureId | "overview", Shot> = {
  ...
  overview: { position: [4.6, 1.7, -5.7], target: [0, 0.72, 0.05] },
...
const MODEL_SHOTS: Partial<Record<ModelId, Partial<Record<FeatureId | "overview", Shot>>>> = {
  "model-3": {
    overview: { position: [4.35, 1.58, -5.45], target: [0, 0.68, 0.08] },
  ...
  "model-y": {
    overview: { position: [4.55, 1.72, -5.75], target: [0, 0.78, 0.08] },
  ...
  "model-3-heritage": {
    overview: { position: [4.45, 1.62, -5.55], target: [0, 0.7, 0.06] },
  ...
  "model-s-heritage": {
    overview: { position: [4.8, 1.68, -5.95], target: [0, 0.72, 0.08] },
  ...
  cybertruck: {
    overview: { position: [5.35, 1.95, -6.35], target: [0, 0.92, 0.15] },
  ...
  cybercab: {
    overview: { position: [3.85, 1.42, -4.65], target: [0, 0.58, 0.05] },
